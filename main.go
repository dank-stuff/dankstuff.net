	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		_ = t.Execute(w, map[string]any{
			...
			"DankStuffProducts": []struct {
				...
				{Title: "DankToolz", Link: "https://danktoolz.com", Description: "A bunch of tools in/for the web.", LogoPath: "/assets/logos/danktoolz.png"},
				{Title: "DankDL", Link: "https://dankdl.com", Description: "An all in all download manager.", LogoPath: "/assets/logos/dankdl.png"},
				{Title: "DankNotes", Link: "https://notes.dankstuff.net", Description: "Bootleg version of Notion and Google Notes.", WIP: true},
				{Title: "DankClip", Link: "https://dankclip.com", Description: "A local/remote clipboard manager.", WIP: true},
				{Title: "DankURL", Link: "https://dankurl.com", Description: "Another URL shortner.", WIP: true},
